...
This was built following the tutorial project on the kubebuilder guide: https://book.kubebuilder.io/cronjob-tutorial/cronjob-tutorial
...
```sh
make build-installer IMG=<some-registry>/cronjob-operator:tag
```
...
```sh
kubectl apply -f https://raw.githubusercontent.com/<org>/cronjob-operator/<tag or branch>/dist/install.yaml
```
