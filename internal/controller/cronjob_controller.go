...
var (
	scheduledTimeAnnotation = "batch.maker2413.dev/scheduled-at"
)

// +kubebuilder:rbac:groups=batch.maker2413.dev,resources=cronjobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=batch.maker2413.dev,resources=cronjobs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=batch.maker2413.dev,resources=cronjobs/finalizers,verbs=update
...
func (r *CronJobReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	*/
	...
	if len(cronJob.Status.Conditions) == 0 {
		...
		// Re-fetch to ensure we are working with the latest version of the object from the API server.
		if err := r.Get(ctx, req.NamespacedName, &cronJob); err != nil {
	...
	*/
	...
	// NOTE: deleting these are "best effort" -- if we fail on a particular one,
